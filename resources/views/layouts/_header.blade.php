                ...
                <div class="app-navbar-item align-items-stretch ms-1 ms-md-3">
                    ...
                    <div id="kt_header_search" class="header-search d-none d-md-flex align-items-stretch"
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <!--begin::Form-->
                            <form class="w-100 position-relative" action="{{ route('navigate') }}" method="POST"
                    ...
                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold py-4 fs-6 w-275px"
                        ...
                        <div class="menu-item px-3">
                            <div class="menu-content d-flex align-items-center px-3">
                                ...
                                <div class="symbol symbol-50px me-5">
                                    <img alt="Logo" src="{{ asset($user->image) }}" />
                                </div>
                                <!--end::Avatar-->
                                <!--begin::Username-->
                                <div class="d-flex flex-column">
                                    ...
                                    <a href="#" class="fw-semibold text-muted text-hover-primary fs-7">{{ $user->email
                                        }}</a>
                                </div>
                                <!--end::Username-->
                            </div>
                        ...
                        <div class="menu-item px-5" data-kt-menu-trigger="{default: 'click', lg: 'hover'}"
                            ...
                            <a href="#" class="menu-link px-5">
                                <span class="menu-title position-relative">Currency
                                    <span
                                        class="fs-8 rounded bg-light px-3 py-2 position-absolute translate-middle-y top-50 end-0">{{
                                        $user->currency->code }}</span></span>
                            </a>
                            <!--begin::Menu sub-->
                            <div class="menu-sub menu-sub-dropdown w-175px py-4">
                                ...
                                <!--begin::Menu item-->
                                <div class="menu-item px-3">
                                    <a href="{{ route('currencies.switch', $currency->id) }}"
