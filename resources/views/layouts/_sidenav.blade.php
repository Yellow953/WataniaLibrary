...
<div id="kt_app_sidebar" class="app-sidebar flex-column" data-kt-drawer="true" data-kt-drawer-name="app-sidebar"
    ...
    <div class="app-sidebar-logo px-6" id="kt_app_sidebar_logo">
        ...
        <a href="{{ route('dashboard') }}" class="d-flex align-items-center justify-content-center">
            <img alt="Logo" src="{{ asset('frontend/images/favicon.png') }}" class="h-50px app-sidebar-logo-default" />
            <img alt="Logo" src="{{ asset('frontend/images/favicon.png') }}" class="h-40px app-sidebar-logo-minimize">
