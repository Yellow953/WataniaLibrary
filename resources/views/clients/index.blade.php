...
<a class="btn btn-primary btn-sm px-4" href="{{ route('clients.export', request()->query()) }}"><i
...
<div class="filter border-0 px-0 px-md-3 py-4">
    <!--begin::Form-->
    <form action="{{ route('clients') }}" method="GET" enctype="multipart/form-data" class="form">
        @csrf
