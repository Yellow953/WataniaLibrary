...
<div class="container mt-5">
    <div class="card">
        <form action="{{ route('expenses.create') }}" method="POST" enctype="multipart/form-data" class="form">
            @csrf
            <div class="card-head">
                <h1 class="text-center text-primary">New Expense</h1>
            </div>
            <div class="card-body">
                <div class="row">
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" name="amount" value="{{ old('amount') }}" min="0"
                                step="any" required>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="description" rows="3"
                                placeholder="Description goes here..." required>{{ old('description') }}</textarea>
                        </div>
                    </div>
                </div>
            </div>
